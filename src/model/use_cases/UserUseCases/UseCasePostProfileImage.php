...
class UseCasePostProfileImage
{
    ...
    private const PROFILE_IMGS_DIR = "/home/vagrant/pwbox/public/profile_imgs/";
    ...
    public function __invoke(UploadedFile $profileImg, $userName)
    {
        ...
        if(!file_exists("/home/vagrant/pwbox/public/profile_imgs")){
            mkdir("/home/vagrant/pwbox/public/profile_imgs", 0777, true);
        }
